...
//  console.log(strings[1].length);
//  console.log(strings[2].length);
...
// const title = [];
// for (let index = 0; index < movies.length; index++) {
//  title[index] = movies[index].Title 
// }
// console.log(title)
/* ESERCIZIO 15
...
// for (let index = 0; index < movies.length; index++) {
//   millenium[index]= movies[index].Year>2000;
// }
